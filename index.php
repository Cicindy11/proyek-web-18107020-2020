...
<head>
    ...
    <title>Tugas Praktikum WEB</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-info">
        <div class="container">
            <a class="navbar-brand" href="index.php?halaman=home">Pemrograman Berbasis WEB</a>
    ...
    <!-- Content -->
    <?php require('application\controllers\Menu.php') ?>
    <!-- Content END -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center text-white">
                    <p class="mb-0">Dibuat Untuk Memenuhi Tugas Matakuliah Pemograman Berbasis WEB</p>
                </div>
            </div>
        </div>
    </div>
